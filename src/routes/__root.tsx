  ...
  head: () => ({
    meta: [
      ...
      { title: "Exotique Machines — Curated Pre-Owned Luxury Cars in Lucknow" },
      {
        name: "description",
        content:
          "A handpicked collection of pre-owned luxury cars in Lucknow. Curated inventory, finance assistance, and a premium showroom experience at Exotique Machines.",
      },
      { property: "og:title", content: "Exotique Machines — Curated Pre-Owned Luxury Cars" },
      {
        property: "og:description",
        content: "Handpicked pre-owned luxury cars in Lucknow, presented with transparency and craft.",
      },
      { property: "og:type", content: "website" },
      { property: "og:site_name", content: "Exotique Machines" },
