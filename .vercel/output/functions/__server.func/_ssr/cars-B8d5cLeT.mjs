//#region node_modules/.nitro/vite/services/ssr/assets/cars-B8d5cLeT.js
var cars = [
	{
		...
		description: "A commanding flagship SUV finished in showroom condition — the Lexus LX 500d Ultra Luxury pairs unshakable off-road capability with a rear cabin engineered for chauffeur-driven comfort.",
		highlights: [
	...
	},
	{
		...
		description: "The definitive luxury MPV. Second-row captain lounges, refined hybrid drivetrain, and an interior best appreciated from the back seat.",
		highlights: [
	...
	},
	{
		...
		description: "The Cayenne Coupe Platinum brings sports-car composure to the SUV silhouette — sharp, quick, and unmistakably Porsche.",
		highlights: [
	...
	},
	{
		...
		description: "The long-wheelbase Range Rover Vogue — a hushed, effortless cabin over a chassis that goes anywhere with quiet authority.",
		highlights: [
	...
	},
	{
		...
		description: "The 740Li M-Sport — a boardroom on wheels, sharpened by M-Sport styling and a silken inline-six.",
		highlights: [
	...
	},
	{
		...
		description: "The current-generation S-Class in S450 4MATIC guise — the benchmark for luxury sedans, delivered with our full inspection and detailing.",
		highlights: [
	...
	},
	{
		...
		price: "₹ 88.00 L",
		image: "https://images.unsplash.com/photo-1606664515524-ed2f786a0bd6?w=1600&q=80",
		description: "Understated presence, exceptional technology. The A8 L Technology trim is the connoisseur's choice in this segment.",
		highlights: [
	...
	},
	{
		...
		price: "₹ 62.00 L",
		image: "https://images.unsplash.com/photo-1555215695-3004980ad54e?w=1600&q=80",
		description: "The F-Pace R-Dynamic combines Jaguar's design language with everyday usability. Sharp, expressive, and beautifully maintained.",
		highlights: [
	...
	},
	{
		...
		price: "₹ 82.00 L",
		image: "https://images.unsplash.com/photo-1614162883005-ddd341faaf9c?w=1600&q=80",
		description: "Scandinavian restraint meets plug-in hybrid efficiency. The XC90 Inscription is quietly one of the most complete luxury SUVs on sale.",
		highlights: [
...
var getCar = (slug) => cars.find((c) => c.slug === slug);
//#endregion
export { getCar as n, cars as t };
